...
//The function
function Hamburger(bunType, vegetables, cheese, sauce, patty, pattyCount, extras) {
    ...
    this.describe = function () {
        return `This hamburger has a ${this.bunType} bun, with ${this.vegetables.join(", ")} vegetables, ${this.cheese} cheese, ${this.sauce} sauce, and ${this.pattyCount} ${this.patty} patties. Extras include ${this.extras.join(", ")}.`;
    };
}
